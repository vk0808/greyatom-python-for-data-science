...
def fuse_msg(message_a,message_b):
    message_a = [int(i) for i in message_a]
    message_b = [int(i) for i in message_b]
    #print(message_a,message_b)
    #Integer division of two numbers
    quotient = message_b[0]//message_a[0]
...
def substitute_msg(message_c):
    message_c = ' '.join(map(str, message_c))
    #print(message_c)
...
def compare_msg(message_d, message_e):
    message_d = ' '.join(map(str, message_d))
    message_e = ' '.join(map(str, message_e))
    #print(message_d,message_e)
...
def extract_msg(message_f):
    message_f = ' '.join(map(str, message_f))
    #Splitting the message into a list
